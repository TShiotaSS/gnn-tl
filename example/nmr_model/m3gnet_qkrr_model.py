...
# df_train =  pd.read_csv(f'/home/k-ishihara/skqulacs/data/m3gnet/{csv_name}_train.csv') # 
# df_test =  pd.read_csv(f'/home/k-ishihara/skqulacs/data/m3gnet/{csv_name}_test.csv') # 
df_train =  pd.read_csv(f'/home/k-ishihara/sklearn/data/m3gnet/m3gnet_train_{element}_{csv_name}.csv') # 
df_test =  pd.read_csv(f'/home/k-ishihara/sklearn/data/m3gnet/m3gnet_test_{element}.csv') # 
# df_train =  pd.read_csv(f'./data/m3gnet/{csv_name}_train.csv') # 
# df_test =  pd.read_csv(f'./data/m3gnet/{csv_name}_test.csv') # 
...
with open(f"qkrr_{csv_name}_m3.log" , "a") as f:
...
### 予測結果をcsvファイルに出力する。
# trainデータの予測結果
# df_train_element["nmr_shift_prediction"] = predictions_kr_train
# atom_vector_col_name = [f"atom_feature_vector_{i+1}" for i in range(64)]
# df_train_element.drop(atom_vector_col_name,axis=1).to_csv("prediction_train_result_lap_opt.csv")
